  ...
  return (
    <div className="animate-fade-in">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-6">
        ...
        {!showForm && (<button onClick={() => { setEditingTipo(null); setShowForm(true); }} className="w-full md:w-auto px-5 py-2.5 bg-[#c8102e] text-white font-medium rounded-md shadow hover:bg-[#a00c24] transition-colors">+ Nuevo Tipo</button>)}
      </div>
