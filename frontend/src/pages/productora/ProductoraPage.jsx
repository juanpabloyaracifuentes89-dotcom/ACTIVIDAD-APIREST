  ...
  return (
    <div className="animate-fade-in">
      <div className="flex justify-between items-center mb-6">
        ...
        {!showForm && (<button onClick={() => { setEditingProductora(null); setShowForm(true); }} className="px-5 py-2.5 bg-[#c8102e] text-white font-medium rounded-md shadow hover:bg-[#a00c24] transition-colors">+ Nueva Productora</button>)}
      </div>
