  ...
  return (
    <div className="animate-fade-in">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-8 pb-4 border-b border-gray-200">
        ...
        {!showForm && (<button onClick={() => { setEditingMedia(null); setShowForm(true); }} className="px-6 py-3 bg-[#c8102e] text-white font-bold rounded-lg shadow-lg hover:bg-[#a00c24] hover:shadow-xl hover:-translate-y-0.5 transition-all">+ Nueva Publicación</button>)}
      </div>
